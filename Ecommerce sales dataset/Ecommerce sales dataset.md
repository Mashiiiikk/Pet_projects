...
```
![](Ecommerce sales dataset/category.png)
...
group by st.season_part
 ```
![](Ecommerce sales dataset/season.png)
...
```
![](Ecommerce sales dataset/discount.png)
...
group by payment_method 
 ```
![](Ecommerce sales dataset/payment.png)
...
## Анализ 
![](Ecommerce sales dataset/dashboard1.png)
![](Ecommerce sales dataset/dashboard2.png)
